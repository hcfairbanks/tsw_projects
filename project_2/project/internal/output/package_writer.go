...
func buildPackageServiceWithCtx(tt *uasset.Timetable, svc *uasset.Service, ctx *ttContext) *PackageService {
	...
	ps := &PackageService{
		CountryName:         RouteCountry(tt.Route),
		RouteName:           RouteDisplayName(tt.Route),
		ServiceName:         buildServiceName(svc, startHM, duration),
...
func buildServiceName(svc *uasset.Service, startHM, duration string) string {

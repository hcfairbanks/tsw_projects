...
SCHEDULE_JSON_PROMPT = (
    ...
    "- location: the station or location name INCLUDING platform/track info "
    "(e.g. 'Milton Keynes Central Platform 6', 'Glendale Track 1'). "
    ...
    '[{"action": "...", "details": "...", "location": "...", "time1": "...", "time2": "..."}, ...]\n'
    "No other text."
)
...
def main():
    ...
    try:
        ...
        print(f"\n{'='*60}")
        print(f"=== ALL {len(route_names)} ROUTE(S) COMPLETE ===")
        print(f"{'='*60}")
